...
- **tabBar**：当下 → 观己 → 炼体 → 食养 → 明理 → 归元（6 个 tab，与 Lovable 一致；第一屏为首页·当下）。
...
- `src/pages/index/`：首页·当下（第一屏）；首次打开未引导时自动跳转 onboarding。
- `src/pages/assessment/`、`practice/`、`diet/`、`knowledge/`、`records/`：观己、炼体、食养、明理、归元。
